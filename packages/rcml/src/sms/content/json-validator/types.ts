...
export type SmsMessageNode = {
  ...
  /**
   * @internal
   * Backend-appended attribute for stop-word / unsubscribe lines.
   * Accepted for round-trip compatibility; the SDK does not generate it.
   */
...
export type SmsPlaceholderNode = {
  ...
  attrs: {
    ...
    /**
     * @internal — backend-appended unsubscribe marker.
     * Only generated by {@link createUnsubscribeNodes}.
     */
    'is-unsubscribe'?: true
  }
}
